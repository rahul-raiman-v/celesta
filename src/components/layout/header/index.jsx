    ...
    <div className="p-6 bg-white sticky top-0 backdrop-blur-lg">
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-x-4">
          <button
            onClick={() => router("/")}
            className="cursor-pointer font-semibold  text-gray-700 text-xl hover:border-gray-700 border-transparent border-b-2 outline-0 px-3 py-2"
          >
            Home
          </button>
          <button
        ...
        <div className="flex items-center gap-x-4">
          <button
            onClick={() => router("/combo")}
            className="bg-gradient-to-r from-amber-500 to-pink-500 whitespace-nowrap rounded-md text-white px-5 py-2.5 cursor-pointer flex items-center gap-x-2 font-semibold text-sm "
          >
            <p>Register Now</p>
